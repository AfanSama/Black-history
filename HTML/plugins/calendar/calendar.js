...
(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '<span id="afan1" class="prev" title="上一月" data-calendar-arrow-date><i class="fa fa-angle-left"></i></span>',
            '<span id="afan2"  class="next" title="下一月" data-calendar-arrow-date><i class="fa fa-angle-right"></i></span>',
            '</div>',
            '</div>',
            ...
            '<div class="calendar-arrow">',
            '<span class="prev" title="上一年" data-calendar-arrow-month><i class="fa fa-angle-left"></i></span>',
            '<span class="next" title="下一年" data-calendar-arrow-month><i class="fa fa-angle-right"></i></span>',
            '</div>',
            '</div>',
